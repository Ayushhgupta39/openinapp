    ...
    <div class="grid grid-cols-2 gap-4 h-screen">
      <div class="col-span-2 md:col-span-1 signin-svg-background flex flex-col justify-between w-full">
        ...
        <div className="signin-social flex justify-center items-center">
          <div className="mx-3 cursor-pointer ml-0 py-5">
            <svg
          ...
          <div className="ml-3 mr-8 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="35"
              height="44"
      ...
      <div className="col-span-2 md:col-span-1 flex items-center  text-left sign-right">
        <div>
          ...
          <div className="flex flex-row mt-2 item-center signin-heads d-blocks">
            ...
            <button
              className="social-signin-btn rounded-lg  bg-white  flex flex-row mt-3 py-2 px-5 margins-auto "
          ...
          <div className="signin-div p-5 bg-white flex flex-col mt-5 log-center">
            <form onSubmit={siginInEmail}>
              ...
              <button
                type="submit"
                className="bg-blue-500 text-white hover:bg-blue-600 font-bold py-2 px-4 rounded-lg mt-4 mb-2 font-montserrat signinbtn"
              >
                Sign In
              </button>
            </form>
          </div>
          <p className="w-100 mb-4 text-left ml-7 sign-up-para text-gray-600 font-lato text-base font-normal">
            Don’t have an account?{" "}
            <a className="text-blue-600 font-lato text-base font-normal sign-up-para">
              Register here
            </a>
          </p>
        </div>
